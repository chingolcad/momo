...
namespace AC
{
	...
	public class LocalVariables : MonoBehaviour, ITranslatable
	{
		...
		{
			LocalVariables.GetVariable (_id).SetValue (_value);
		}
		...
		public static void SetBooleanValue (int _id, bool _value)
		{
			if (_value)
			{
				LocalVariables.GetVariable (_id).SetValue (1);
			}
			else
			{
				LocalVariables.GetVariable (_id).SetValue (0);
			}
		}
		...
		{
			LocalVariables.GetVariable (_id).SetFloatValue (_value);
		}
		...
		{
			LocalVariables.GetVariable (_id).SetVector3Value (_value);
		}

	...
	public class SceneManager : ScriptableObject
	{
		...
		private void VisibilityGUI ()
		{
			...
			if (showVisibility)
			{
				...
				GUILayout.Label (new GUIContent (" Triggers", icon), GUILayout.MaxWidth (120f), GUILayout.Height (20f));
				if (GUILayout.Button ("On", EditorStyles.miniButtonLeft, GUILayout.Height (20f)))
				{
					SetTriggerVisibility (true);
				}
				if (GUILayout.Button ("Off", EditorStyles.miniButtonRight, GUILayout.Height (20f)))
				{
				...
				GUILayout.Label (new GUIContent (" Collision", icon), GUILayout.MaxWidth (120f), GUILayout.Height (20f));
				if (GUILayout.Button ("On", EditorStyles.miniButtonLeft, GUILayout.Height (20f)))
				{
				...
				GUILayout.Label (new GUIContent (" Hotspots", icon), GUILayout.MaxWidth (120f), GUILayout.Height (20f));
				if (GUILayout.Button ("On", EditorStyles.miniButtonLeft, GUILayout.Height (20f)))
				{
				...
				GUILayout.Label (new GUIContent (" Markers", icon), GUILayout.MaxWidth (120f), GUILayout.Height (20f));
				if (GUILayout.Button ("On", EditorStyles.miniButtonLeft, GUILayout.Height (20f)))
				{
				...
				GUILayout.Label (new GUIContent (" NavMesh", icon), GUILayout.MaxWidth (120f), GUILayout.Height (20f));
				if (GUILayout.Button ("On", EditorStyles.miniButtonLeft, GUILayout.Height (20f)))
				{
						...
						if (KickStarter.sceneSettings.attributes.Count > 0)
						{
							foreach (InvVar attribute in KickStarter.sceneSettings.attributes)
							{
								...
								if (attribute.type == VariableType.Boolean)
								{
									...
									attribute.val = CustomGUILayout.Popup (label, attribute.val, boolType, apiPrefix + ".val");
								}
								else if (attribute.type == VariableType.Integer)
								{
									attribute.val = CustomGUILayout.IntField (label, attribute.val, apiPrefix + ".val");
								}
								else if (attribute.type == VariableType.PopUp)
								{
									attribute.val = CustomGUILayout.Popup (label, attribute.val, attribute.popUps, apiPrefix + ".val");
								}
								else if (attribute.type == VariableType.String)
								{
									attribute.textVal = CustomGUILayout.TextField (label, attribute.textVal, apiPrefix + ".textVal");
								}
								else if (attribute.type == VariableType.Float)
								{
									attribute.floatVal = CustomGUILayout.FloatField (label, attribute.floatVal, apiPrefix + ".floatVal");
								}
							}

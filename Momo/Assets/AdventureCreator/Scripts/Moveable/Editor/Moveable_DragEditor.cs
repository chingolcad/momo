		...
		public override void OnInspectorGUI ()
		{
			...
			if (_target.dragMode == DragMode.LockToTrack)
			{
				...
				if (_target.actionListSource == ActionListSource.InScene)
				{
					...
					if (_target.interactionOnMove != null && _target.interactionOnMove.source == ActionListSource.InScene && _target.interactionOnMove.NumParameters > 0)
					{
						EditorGUILayout.BeginHorizontal ();
					...
					else if (_target.interactionOnMove != null && _target.interactionOnMove.source == ActionListSource.AssetFile && _target.interactionOnMove.assetFile != null && _target.interactionOnMove.assetFile.NumParameters > 0)
					{
						EditorGUILayout.BeginHorizontal ();

...
namespace AC
{
	...
	public class Serializer : MonoBehaviour
	{
		...
		/**
		 * <summary>Gets a ConstantID component in the scene with a given ID value.</summary>
		 * <param name = "constantID">The Constant ID number generated by the ConstantID component</param>
		 * <returns>The ConstantID component with the correct ID. If none is found, returns null.</returns>
		 */
		public static ConstantID returnConstantID (int constantID)
		{
			...
			{
				return Serializer.returnComponent <ConstantID> (constantID);
			}
			#endif
			...
			if (constantID != 0)
			{
				...
				{
					if (constantIDComponent.constantID == constantID)
					{
						// Found it
